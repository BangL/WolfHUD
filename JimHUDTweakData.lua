JimHUDTweakData = JimHUDTweakData or class()
function JimHUDTweakData:init()
	----------------------------------------------------------------------------------------------------------------------
	-- JimHUD Tweak Data																								--
	----------------------------------------------------------------------------------------------------------------------
...
--]]
	...
	self.CHARACTER_NAMES = {
		[ "civilian" ]								= { default = "jimhud_enemy_civilian" },
		[ "civilian_female" ]						= { default = "jimhud_enemy_civilian" },
		[ "captain" ]								= { default = "jimhud_enemy_civilian" },
		[ "gangster" ]								= { default = "jimhud_enemy_gangster" },
		[ "biker" ]									= { default = "jimhud_enemy_biker" },
		[ "biker_escape" ]							= { default = "jimhud_enemy_biker" },
		[ "bolivian_indoors" ]						= { default = "jimhud_enemy_bolivian_security" },
		[ "bolivian" ]								= { default = "jimhud_enemy_bolivian_thug" },
		[ "mobster" ]								= { default = "jimhud_enemy_mobster" },
		[ "security" ]								= { default = "jimhud_enemy_security" },
		[ "security_undominatable" ]				= { default = "jimhud_enemy_security" },
		[ "mute_security_undominatable" ]			= { default = "jimhud_enemy_security" },
		[ "gensec" ]								= { default = "jimhud_enemy_gensec" },
		[ "cop" ]									= { default = "jimhud_enemy_cop" },
		[ "cop_female" ]							= { default = "jimhud_enemy_cop" },
		[ "cop_scared" ]							= { default = "jimhud_enemy_cop" },
		[ "fbi" ]									= { default = "jimhud_enemy_fbi" },
		[ "swat" ]									= { default = "jimhud_enemy_swat" },
		[ "heavy_swat" ]							= { default = "jimhud_enemy_heavy_swat" },
		[ "fbi_swat" ]								= { default = "jimhud_enemy_swat" },
		[ "fbi_heavy_swat" ]						= { default = "jimhud_enemy_heavy_swat" },
		[ "heavy_swat_sniper" ]						= { default = "jimhud_enemy_heavy_swat_sniper" },
		[ "city_swat" ]								= { default = "jimhud_enemy_city_swat" },
		[ "shield" ]								= { default = "jimhud_enemy_shield" },
		[ "spooc" ]									= { default = "jimhud_enemy_spook" },
		[ "shadow_spooc"]							= { default = "jimhud_enemy_shadow_spook" },
		[ "taser" ]									= { default = "jimhud_enemy_taser" },
		[ "sniper" ]								= { default = "jimhud_enemy_sniper" },
		[ "medic" ]									= { default = "jimhud_enemy_medic" },
		[ "tank" ]									= { default = "jimhud_enemy_tank" },
		[ "tank_hw" ]								= { default = "jimhud_enemy_tank_hw" },
		[ "tank_medic" ]							= { default = "jimhud_enemy_tank_medic" },
		[ "tank_mini" ]								= { default = "jimhud_enemy_tank_mini" },
		[ "phalanx_minion" ]						= { default = "jimhud_enemy_phalanx_minion" },
		[ "phalanx_vip" ]							= { default = "jimhud_enemy_phalanx_vip" },
		[ "swat_van_turret_module" ]				= { default = "jimhud_enemy_swat_van" },
		[ "ceiling_turret_module" ]					= { default = "jimhud_enemy_ceiling_turret" },
		[ "ceiling_turret_module_no_idle" ]			= { default = "jimhud_enemy_ceiling_turret" },
		[ "ceiling_turret_module_longer_range" ]	= { default = "jimhud_enemy_ceiling_turret" },
		[ "aa_turret_module" ]						= { default = "jimhud_enemy_aa_turret" },
		[ "crate_turret_module" ]					= { default = "jimhud_enemy_crate_turret" },
		[ "sentry_gun" ]							= { default = "jimhud_enemy_sentry_gun" },
		[ "mobster_boss" ]							= { default = "jimhud_enemy_mobster_boss" },
		[ "chavez_boss" ]							= { default = "jimhud_enemy_chavez_boss" },
		[ "drug_lord_boss" ]						= { default = "jimhud_enemy_druglord_boss" },
		[ "drug_lord_boss_stealth" ]				= { default = "jimhud_enemy_druglord_boss_stealth" },
		[ "biker_boss" ]							= { default = "jimhud_enemy_biker_boss" },
		[ "bank_manager" ]							= { default = "jimhud_enemy_bank_manager", dah = "jimhud_enemy_dah_ralph" },
		[ "inside_man" ]							= { default = "jimhud_enemy_inside_man" },
		[ "escort_undercover" ]						= { default = "jimhud_enemy_escort_undercover", run = "jimhud_enemy_escort_heatstreet", rvd1 = "jimhud_enemy_escort_reservoirdogs" },
		[ "escort_chinese_prisoner" ]				= { default = "jimhud_enemy_escort_chinese_prisoner" },
		[ "escort_cfo" ]							= { default = "jimhud_enemy_escort_cfo" },
		[ "drunk_pilot" ]							= { default = "jimhud_enemy_drunk_pilot", bph = "jimhud_enemy_escort_bain_locke" },
		[ "escort" ]								= { default = "jimhud_enemy_escort" },
		[ "boris" ]									= { default = "jimhud_enemy_boris" },
		[ "spa_vip" ]								= { default = "jimhud_enemy_spa_vip" },
		[ "spa_vip_hurt" ]							= { default = "jimhud_enemy_spa_vip_hurt" },
		[ "old_hoxton_mission" ]					= { default = "jimhud_enemy_locke_mission", hox_1 = "jimhud_enemy_old_hoxton_mission", hox_2 = "jimhud_enemy_old_hoxton_mission", rvd1 = "jimhud_enemy_reservoirdogs", rvd2 = "jimhud_enemy_reservoirdogs" },
		[ "hector_boss" ]							= { default = "jimhud_enemy_hector_boss" },
		[ "hector_boss_no_armor" ]					= { default = "jimhud_enemy_hector_boss_no_armor" },
		[ "robbers_safehouse" ]						= { default = "jimhud_enemy_crew", bph = "jimhud_enemy_kento" },
		[ "butler" ]								= { default = "jimhud_enemy_butler" },
		[ "vlad" ]									= { default = "jimhud_enemy_vlad" },
...
function JimHUDTweakData:post_init()
